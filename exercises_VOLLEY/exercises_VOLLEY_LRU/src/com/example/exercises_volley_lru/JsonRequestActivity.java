package com.example.exercises_volley_lru;

import com.example.exercises_volley_lru.AppController;
import com.example.exercises_volley_lru.Const;
	...
	private void makeJsonObjReq() {
		...
		JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET,
			...
			protected Map<String, String> getParams() {
				...
				params.put("name", "Gerald Gono");
				params.put("email", "g.gono@klab.com");
				params.put("pass", "qwerty");
